...
class hr_contract(models.Model):
    ...
    isapre_cotizacion_uf = fields.Float('Cotización ISAPRE UF', digits=(6, 4),  help="Cotización Pactada")
    ...
    seguro_complementario = fields.Float('Cotización Seguro Complementario',  help="Seguro Complementario")
